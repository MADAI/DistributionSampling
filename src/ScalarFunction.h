 ...
 *
 * This is an abstract class.  Some particular ScalarFunction should
 * override this.  If you do, be sure to populate m_Parameters and
 * m_ScalarOutputName and implement GetOutput();
 */
class ScalarFunction {
public:
  /** ErrorType */
  ...
  /** constructor sets a default for m_ScalarOutputName. */
