...
int main( int, char *[] ) {
  ...
  std::string settingsFile( "GetPosteriorAnalysisDirectoryTest.dat" );
  ...
  std::string posteriorAnalysisDirectory( "posteriorAnalysisDirectory" );

  tempFile << "POSTERIOR_ANALYSIS_DIRECTORY " << posteriorAnalysisDirectory << "\n";
  tempFile.close();
  ...
  expectedDirectory += madai::Paths::SEPARATOR + posteriorAnalysisDirectory;
  ...
  expectedDirectory = madai::Paths::SEPARATOR + std::string( "home" )
    + madai::Paths::SEPARATOR + posteriorAnalysisDirectory;

  actualDirectory = madai::GetPosteriorAnalysisDirectory( statisticsDirectory, settings );
  if ( expectedDirectory != actualDirectory ) {
    std::cerr << "Model directory was expected to be '" << expectedDirectory
              << "' but got '" << actualDirectory << "'.\n";
    return EXIT_FAILURE;
